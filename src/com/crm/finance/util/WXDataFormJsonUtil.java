...
public class WXDataFormJsonUtil {
    ...
    public static ArrayList<Object> getMessageDataInDB(Context context, SQLiteDatabase dataTarget, File file) {
        String uploadTimeStr = GlobalCofig.MESSAGE_LAST_UPLOAD_TIME + file.getPath();
        long message_last_upload_time = ShareData.getInstance().getLongValue(context,uploadTimeStr , 0);
        LogInputUtil.e(TAG, "取出的的message_last_upload_time = " + message_last_upload_time+",path="+uploadTimeStr);
     ...
     * 打包封装需要上传的数据
     **/
    public static String getUploadJsonStr(String tag, ArrayList<Object> dataList, String pathUin, String wxIMEI, String userName) {
        ...
        uploadDataDao.setDeviceID(Utils.getDeviceId());
        uploadDataDao.setWxIMEI(wxIMEI);
