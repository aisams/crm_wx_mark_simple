...
public class GlobalCofig {
    ...
    public static final String SERVICE_DEVICESTATE = "/weixin/devicestate";//上报心跳
    public static final String SERVICE_DEVICEHEARTBEAT = "/weixin/deviceheartbeat";//上报数据上传状态
    ...
    public static final String SHARE_UPDATETIME = "SHARE_UPDATETIME";//数据有上传时间，用于UI正常异常展示
    public static final long UPLOAD_NORMAL_TIME = 1000 * 60 * 60;//首页留痕状态异常间隔，单位/毫秒，超过该时长算异常
    public static final long EXECUTE_STATE_UI = 1000 * 5;//执行首页状态UI刷新
